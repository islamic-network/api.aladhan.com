...
#[OA\Components(
    ...
    parameters: [
        ...
        new OA\PathParameter(parameter: 'start', name: 'start', description: 'Specific gregorian date in DD-MM-YYYY format', in: 'path',
            required: true, schema: new OA\Schema(type: 'string'), example: '01-01-2025'),
        new OA\PathParameter(parameter: 'end', name: 'end', description: 'Specific gregorian date in DD-MM-YYYY format - must be no more than 11 months greater than the start date', in: 'path',
